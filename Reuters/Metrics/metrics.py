...
DOCVEC_DIR = "../SVM_classifier"

sparsity = 1
embedding_type = "doc2vec" #doc2vec and word2vec
multisense = 1
for sparsity in [0,1]:
    for embedding_type in ["word2vec"]:
...
# Load feature vectors.
            ...
            gwbowv = np.load(os.path.join(DOCVEC_DIR,gwbowv_name))
            ...
            gwbowv_test = np.load(os.path.join(DOCVEC_DIR,test_gwbowv_name))
		...
		f.write("Label Ranking Average precision score: "+str(label_ranking_average_precision_score(Y_test, pred_proba))+"\n")

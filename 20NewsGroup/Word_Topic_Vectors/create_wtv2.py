...
def get_probability_word_vectors(featurenames, word_centroid_map, num_clusters, word_idf_dict):
	...
	for word in word_centroid_map:
		try:
			prob_wordvecs[word] = (np.array([word_centroid_prob_map[word]])).transpose()*np.array([word_vectors[word]])*word_idf_dict[word]
		except:
			continue
...
if choice == "doc2vecc":
	model_name = "Doc2VecC_Polysemy_"+str(num_features)+".txt"
	print("Embeddings = Doc2VecC")
elif choice == "word2vec":
	model_name = "Word2Vec_Polysemy_"+str(num_features)+".txt"
